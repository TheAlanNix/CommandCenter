...
export default {
  ...
  methods: {
    getActions() {
      const path = `/api/ise/anc_policies`;
      axios
        .get(path)
        .then((res) => {
          console.log(res);
    ...
    getIseSessionData() {
      const path = `/api/ise/session_data/${this.hostIp}`;
      axios
        .get(path)
        .then((res) => {
          console.log(res);
    ...
    getIseAncStatus(macAddress) {
      const path = `/api/ise/anc_status/${macAddress}`;
      console.log(path);
      axios
        .get(path)
        .then((res) => {
    ...
    setIseAncStatus(macAddress, ancPolicy) {
      const path = `/api/ise/anc_status`;
      const payload = {
        macAddress: macAddress,
        policyName: ancPolicy,
      };
      axios
        .post(path, payload)
        .then((res) => {
