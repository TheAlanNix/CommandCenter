<template>
  <div class="event-details-panel-content">
    ...
    <b-row>
      <b-col>
        <span class="content">
          ...
          <ul>
            <li v-for="(tag, index) in event.source.tags" :key="index">{{ tag.name }}</li>
          </ul>
        </span>
      </b-col>
    </b-row>
    ...
    <b-row>
      <b-col>
        <span class="content">
          ...
          <ul>
            <li v-for="(tag, index) in event.target.tags" :key="index">{{ tag.name }}</li>
          </ul>
        </span>
      </b-col>
    </b-row>
    ...
    <b-row>
      <b-col>
        <span class="content">{{ event.event_details }}</span>
      </b-col>
    </b-row>
  </div>
</template>
